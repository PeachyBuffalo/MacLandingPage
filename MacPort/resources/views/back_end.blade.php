    ...
    <div>
        <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            <div class="text-center">
                ...
                <p class="text-2xl text-gray-700">Back-end Dev Showcase</p>
            </div>
        <div class="mt-6 border-t border-b border-gray-200 py-6 px-4 sm:px-6 lg:px-8 bg-gray-300">
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Back-end Developer</dd>
            </div>
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                <dt class="text-sm font-medium leading-6 text-gray-900">Client Contact</dt>
                <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">macall.smith@gmail.com</dd>
            </div>
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
            ...
            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <ul role="list" class="divide-y divide-gray-100 rounded-md border border-gray-200">
                    ...
                    <div class="flex w-0 flex-1 items-center">
                        ...
                        <span class="truncate font-medium">front_end_developer_work.pdf</span>
                        <!-- Automate pdf sizing component -->
                        <span class="flex-shrink-0 text-gray-400">10mb</span>
                        </div>
                    </div>
                    <div class="ml-4 flex-shrink-0">
                        <!-- Attach Download links component -->
